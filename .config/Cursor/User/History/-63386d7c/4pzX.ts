...
import { ApiOperation, ApiSecurity, ApiTags, ApiResponse, ApiBadRequestResponse, ApiForbiddenResponse, ApiNotFoundResponse, ApiBearerAuth } from '@nestjs/swagger';
...
export class OrdersController implements CrudController<Order> {
  ...
  @Get('/count')
  @ApiOperation({ summary: 'Retrieve total number of orders' })
  ...
  @ApiOperation({ summary: 'Update an order with kind = reference_data' })
