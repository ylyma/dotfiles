...
import { PubSubServer } from './modules/messages/pubsub/pubsub.server';
...
import { serve as redocServe, RedocOptions } from 'redoc-express';
...
async function bootstrap() {
  ...
  if (process.env.APP_ENV !== 'production') {
    ...
    const redocOptions: RedocOptions = {
      title: 'AltaX Exchange API Documentation',
      specUrl: '/api-json', // NestJS automatically serves OpenAPI spec at /api-json
      redocOptions: {
    ...
    app.use('/docs', redocServe(redocOptions));
  }
