...
async function bootstrap() {
  ...
  if (process.env.APP_ENV !== 'production') {
    ...
    // redoc page available at this url
        ...
        const html = `
          ...
          <html>
            <head>
              ...
              <!-- Load the redoc bundle from our static assets -->
              <script src="/redoc-bundle/redoc.standalone.js"></script>
            </head>
            <body>
      ...
      // Serve the Redoc bundle from the npm package - proper NestJS way
      app.useStaticAssets(path.join('node_modules/redoc/bundles'), {
        prefix: '/redoc-bundle',
      });
