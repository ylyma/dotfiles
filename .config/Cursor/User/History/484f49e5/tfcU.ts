...
export class ImportJobController implements CrudController<ImportJob> {
  ...
  @ApiOperation({
    ...
    description: 'Uploads a file containing orders and creates an import job to process them asynchronously.\n' +
      'The job will:\n' +
  ...
  @ApiOperation({
    ...
    description: 'Retrieves a paginated list of bulk order import jobs.\n' +
